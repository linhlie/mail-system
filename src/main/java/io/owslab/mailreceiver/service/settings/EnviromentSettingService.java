...
public class EnviromentSettingService {
    ...
    public static final String ADD_NEW_EMAIL_TO_PEOPLE_IN_CHARGE_PARTNER_UNREGISTER_KEY = "add_new_email_to_people_in_charge_partner_unregister";
    ...
    public static final String CC_ADMINSTRATOR_MAIL_ADDRESS_KEY = "cc_adminstrator_mail_address";
    ...
    private static final String DEFAULT_ADD_NEW_EMAIL_TO_PEOPLE_IN_CHARGE_PARTNER_UNREGISTER = "0";
    ...
    private static final String DEFAULT_CC_ADMINSTRATOR_MAIL_ADDRESS = "";
    ...
    private static HashMap<String, String> createMap()
    {
        ...
        map.put(ADD_NEW_EMAIL_TO_PEOPLE_IN_CHARGE_PARTNER_UNREGISTER_KEY, DEFAULT_ADD_NEW_EMAIL_TO_PEOPLE_IN_CHARGE_PARTNER_UNREGISTER);
        ...
        map.put(CC_ADMINSTRATOR_MAIL_ADDRESS_KEY, DEFAULT_CC_ADMINSTRATOR_MAIL_ADDRESS);
    ...
    public boolean getAddNewPeopleInChargePartnerUnregister(){
        String value = this.getSetting(ADD_NEW_EMAIL_TO_PEOPLE_IN_CHARGE_PARTNER_UNREGISTER_KEY, DEFAULT_ADD_NEW_EMAIL_TO_PEOPLE_IN_CHARGE_PARTNER_UNREGISTER);
        return value != null && value.equals("1");
    }
    ...
    public String getCcAdministratorMailAddress(){
        return this.getSetting(CC_ADMINSTRATOR_MAIL_ADDRESS_KEY, DEFAULT_CC_ADMINSTRATOR_MAIL_ADDRESS);
    }
